...
class WeddingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wedding" do
    assert_difference('Wedding.count') do
      post weddings_url, params: { wedding: { description: @wedding.description, name: @wedding.name } }
    end
  ...
  test "should update wedding" do
    patch wedding_url(@wedding), params: { wedding: { description: @wedding.description, name: @wedding.name } }
